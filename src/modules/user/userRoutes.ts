...
route.post("/sign-up", V.validate(signUpModel), userC.createNewUser);
...
route.put(
  "/rating",
  V.validate(updateRatings),
  userM.isBookingExist,
  userC.updateRatings
);
...
route.put(
  "/update-raised-concern-ticket",
  userC.updateRaiseConcernTicketStatus
);
